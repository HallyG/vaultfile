...
GO_CMD ?= go
GO_LDFLAGS ?= -s -w -buildid= -X 'main.BuildShortSHA=$(BUILD_SHORT_SHA)' -X 'main.BuildVersion=$(BUILD_VERSION)'
GO_PKG_MAIN := ${PWD}/cmd/vaultfile/cli
GO_PKGS := $(PWD)/internal/... $(PWD)/cmd/vaultfile/cli/... 
